...
exports.getPlatformPrompts = getPlatformPrompts;
exports.buildEmptyBackdropPrompt = buildEmptyBackdropPrompt;
...
function getPlatformPrompts(platform, backgroundStyle, analysis, brandName, extraContext) {
...
function buildEmptyBackdropPrompt(style, platformHints) {
...
function buildBackgroundPrompt(style, analysis, platformHints) {
    const styleDescriptions = {
...
function getBackgroundDescription(style) {
    const map = {
